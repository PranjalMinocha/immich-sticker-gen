...
def load_config() -> IngestionConfig:
    ...
    return IngestionConfig(
        ...
        hard_fail_rate_max=_get_float("HARD_FAIL_RATE_MAX", 0.10),
        soft_warn_rate_max=_get_float("SOFT_WARN_RATE_MAX", 0.50),
        ...
        min_bbox_area_ratio=_get_float("MIN_BBOX_AREA_RATIO", 0.00001),
        max_bbox_area_ratio=_get_float("MAX_BBOX_AREA_RATIO", 0.98),
        tiny_bbox_warn_ratio=_get_float("TINY_BBOX_WARN_RATIO", 0.001),
        huge_bbox_warn_ratio=_get_float("HUGE_BBOX_WARN_RATIO", 0.80),
        min_blur_variance_warn=_get_float("MIN_BLUR_VARIANCE_WARN", 30.0),
        min_brightness_warn=_get_float("MIN_BRIGHTNESS_WARN", 0.05),
        max_brightness_warn=_get_float("MAX_BRIGHTNESS_WARN", 0.95),
        max_near_dup_distance=_get_int("MAX_NEAR_DUP_DISTANCE", 5),
